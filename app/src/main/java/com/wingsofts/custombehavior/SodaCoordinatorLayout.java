...
/**
 * Created by wuzp on 2017/12/9.
 * 可行，只要你敢想 就一定能成功
 */
public class SodaCoordinatorLayout extends CoordinatorLayout {
    ...
    public SodaCoordinatorLayout(Context context) {
        super(context);
        init(null);
    }

    public SodaCoordinatorLayout(Context context, AttributeSet attri) {
        super(context, attri);
        init(attri);
    }

    public SodaCoordinatorLayout(Context context, AttributeSet attri, int flag) {
    ...
    public interface ScrollViewListener {
        void onScrollChanged(SodaCoordinatorLayout scrollView, int x, int y, int oldx, int oldy);
    }
}
